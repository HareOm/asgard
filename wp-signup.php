...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action="wp-signup.php">
		...
		<p class="submit"><input type="submit" name="submit" class="btn btn-primary btn-lg btn-block" value="<?php esc_attr_e( 'Create Site' ) ?>" /></p>
	</form>
	<?php
}
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	<h2><?php printf( __( 'Join the Movement' ), get_current_site()->site_name ) ?></h2>
	<form id="setupform" method="post" action="wp-signup.php" novalidate="novalidate">
		...
		<p class="submit"><input type="submit" name="submit" class="btn btn-primary btn-lg btn-block" value="<?php esc_attr_e('Join') ?>" /></p>
	</form>
	<?php
}
